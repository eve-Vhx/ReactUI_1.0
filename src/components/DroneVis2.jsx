...
function DroneVis(props) {
    ...
    for (var i=0; i<props.drone_obj_array.length; i++) {
        if(props.drone_obj_array[i].initialized) {
        telem_tabs.push(
            <Tab eventKey={props.drone_obj_array[i].id} title={props.drone_obj_array[i].id}>
                <Table striped bordered responsive variant="dark" style={{fontSize: "0.5em"}}>
                    ...
                    <tbody className='justify-content-center'>
                        ...
                        <tr>
                            <th><h4>Battery</h4></th>
                            <th><h4>{props.drone_obj_array[i].battery}%</h4></th>
                        </tr>
                    </tbody>
                </Table>
